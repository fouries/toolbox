...
assert.match(source, /<text\s+class="quick-tool-desc">\{\{\s*tool\.desc\s*\}\}<\/text>/, 'popular tool cards should show the tool description under the name')
...
assert.match(source, /\.quick-tool-info\s*\{[\s\S]*width:\s*100%;/, 'popular tool text should use the full card width')
assert.match(source, /\.quick-tool-card\s*\{[\s\S]*min-height:\s*148rpx;/, 'popular tool cards should be compact vertical cards')
assert.match(source, /\.quick-tool-card\s*\{[\s\S]*padding:\s*14rpx 14rpx 12rpx;/, 'popular tool cards should use compact vertical padding')
...
assert.match(source, /@media\s*\(min-width:\s*768px\)[\s\S]*\.quick-tool-card\s*\{[\s\S]*min-height:\s*96px;/, 'desktop popular tool cards should use compact vertical cards')
