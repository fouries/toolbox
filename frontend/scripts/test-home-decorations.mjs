...
assert.match(source, /\.quick-tool-list\s*\{[\s\S]*display:\s*grid;[\s\S]*grid-template-columns:\s*repeat\(4,\s*minmax\(0,\s*1fr\)\);/, 'popular tools should use four shorter full-width columns without leaving trailing blank space')
...
assert.match(source, /\.quick-tool-info\s*\{[\s\S]*width:\s*100%;/, 'popular tool name should use the full compact card width')
assert.match(source, /\.quick-tool-card\s*\{[\s\S]*min-height:\s*88rpx;/, 'popular tool cards should be shorter without descriptions')
...
assert.match(source, /@media\s*\(min-width:\s*768px\)[\s\S]*\.quick-tool-list\s*\{[\s\S]*grid-template-columns:\s*repeat\(4,\s*minmax\(0,\s*1fr\)\);/, 'desktop popular tools should keep full-width compact card columns')
assert.match(source, /@media\s*\(min-width:\s*768px\)[\s\S]*\.quick-tool-card\s*\{[\s\S]*min-height:\s*60px;/, 'desktop popular tool cards should be shorter without descriptions')
