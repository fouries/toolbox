...
for (const file of [solarTermsPagePath, infoNewsPagePath, goldPagePath]) {
...
assert.match(solarTermsPage, /currentTerm|nextTerm/, 'solar terms page should highlight current or next solar term')
