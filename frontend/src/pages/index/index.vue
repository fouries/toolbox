...
const tools = ref<ToolItem[]>([
  ...
  { id: 'image-toolbox', name: '图片工具箱', desc: '压缩、转格式、改尺寸、加水印', icon: '🖼️', color: '#0ea5e9', category: 'utility', path: '/pages/image-toolbox/index', implemented: true, keywords: ['图片', '压缩', '格式转换', '尺寸', '水印', 'Base64', 'JPG', 'PNG', 'WEBP'] },
  { id: 'parenting', name: '育儿工具', desc: '孕晚期到 6 岁育儿助手', icon: '👶', color: '#fb7185', category: 'life', path: '/pages/parenting/index', implemented: true, keywords: ['育儿', '孕晚期', '胎动', '宝宝', '喂养', '睡眠', '疫苗', '体检', '入园'] },
